...
public class WeaveContentProvider extends ContentProvider {
	...
	public static final String AUTHORITY = "sf.browser.providers.weavecontentprovider";
	...
	public Uri insert(Uri uri, ContentValues values) {
		...
		case WEAVE_BOOKMARKS:
			...
			if (rowId > 0) { 
				...
				this.mContext.getContentResolver().notifyChange(rowUri, null);
				return rowUri;
			}
	...
	public int delete(Uri uri, String selection, String[] selectionArgs) {
		...
		switch(sUriMatcher.match(uri)) {
		case WEAVE_BOOKMARKS:
			count = mDb.delete(WEAVE_BOOKMARKS_TABLE, selection, selectionArgs);
			break;
		default:
			throw new IllegalArgumentException("Unknown URI " + uri);
		}
