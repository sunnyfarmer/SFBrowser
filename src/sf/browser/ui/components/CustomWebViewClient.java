package sf.browser.ui.components;
...
public class CustomWebViewClient extends WebViewClient {
	...
	public void onPageStarted(android.webkit.WebView view, String url, android.graphics.Bitmap favicon) {
		// Some magic here: where performing WebView.loadDataWithBaseURL, the url is "file:///android_asset/startpage,
		...
		if (url.equals(Constants.URL_ABOUT_START)) {
			view.loadDataWithBaseURL("file:///android_asset/startpage/", ApplicationUtils.getStartPage(view.getContext()), "text/html", "UTF-8", "about:start");
		}
	...
	public void onReceivedHttpAuthRequest(WebView view,
		...
		boolean requestHttpAuthUsernamePassword = handler.useHttpAuthUsernamePassword();
		
		if (requestHttpAuthUsernamePassword && view != null) {
