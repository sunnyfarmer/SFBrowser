...
import sf.browser.R;
import sf.browser.model.adapters.BookmarksCursorAdapter;
...
public class BookmarksListActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
	    ...
	    this.setContentView(R.layout.bookmarks_list_activity);
	    
	    this.setTitle(R.string.BookmarksListActivity_Title);
	    
	    View emptyView = this.findViewById(R.id.BookmarksListActivity_EmptyTextView);
	    mList = (ListView) this.findViewById(R.id.BookmarksListActivity_List);
	...
	private void fillData() {
		...
		mCursorAdapter = new BookmarksCursorAdapter(this, R.layout.bookmark_row, mCursor, from, to, ApplicationUtils.getFaviconSizeForBookmarks(this));
	...
	/**
	 * Set the list loading animaiton.
	 */
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		item = menu.add(0, MENU_SORT_MODE, 0, R.string.BookmarksListActivity_MostUsedSortMode);
	...
	public boolean onContextItemSelected(MenuItem item) {
		...
		case MENU_DELETE_BOOKMARK:
			BookmarksProviderWrapper.deleteStrockBookmark(getContentResolver(), info.id);
			fillData();
			return true;
		default:
	...
	private void changeSortMode() {
		...
		builder.setTitle(getResources().getString(R.string.BookmarksListActivity_MostUsedSortMode));
