...
public class PreferencesActivity extends PreferenceActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
	    ...
	    PreferenceCategory browserPreferenceCategory = (PreferenceCategory) this.findPreference("BrowserPreferenceCategory");
	    Preference enablePluginsEclair = (Preference) this.findPreference(Constants.PREFERENCES_BROWSER_ENABLE_PLUGINS_ECLAIR);
	    Preference enablePlugins = (Preference) this.findPreference(Constants.PREFERENCES_BROWSER_ENABLE_PLUGINS);
	...
	private void doExportHistoryBookmarks() {
		if (ApplicationUtils.checkCardState(this, true)) {
			...
			XmlHistoryBookmarksExporter exporter = new XmlHistoryBookmarksExporter(this, DateUtils.getNowForFileName() + ".xml",
	...
	private class CacheClearer implements Runnable {
		...
		@Override
		public void run() {
			//Only need to clear the cache from one WebView, as it is applicaiton-based.
