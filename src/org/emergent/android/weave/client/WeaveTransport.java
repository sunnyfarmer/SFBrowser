...
public class WeaveTransport {
	...
	public WeaveTransport(boolean useConnectionPool, boolean allowInvalidCerts) {
		this.m_sslSocketFactory = createSocketFactory(allowInvalidCerts);
		this.m_clientConMgr = useConnectionPool ? createClientConnectionManager(true) : null;
	}
	...
	private static class MyResponseHandler implements ResponseHandler<WeaveResponse> {
		@Override
		public WeaveResponse handleResponse(HttpResponse response)
